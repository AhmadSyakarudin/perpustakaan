    ...
    <div class="container mt-3">
        ...
        <div class="d-flex justify-content-between align-items-center bg-light rounded p-3 shadow-sm">
            <form action="#" method="GET" class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('peminjaman.admin') }}" class="btn btn-secondary btn-lg px-4">Clear</a>
            </form>
            <a href="{{ route('peminjaman.admin.export') }}" class="btn btn-success btn-lg px-4 shadow">Export Excel</a>
        </div>
